...
public class DealerManagingUI extends JFrame{
    ...
    private JLabel dealerID, carID, brand, category, price, type,color,mileage;
    private JTextField  carIDText, priceText,brandText,modelText;
    private JComboBox typeChoice, categoryChoice;
